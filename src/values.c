...
// Set 1 (High Light)
unsigned const char ditherHighLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
// Set 2 (Low Light)
unsigned const char ditherLowLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
unsigned const char ditherNoHighLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
unsigned const char ditherNoLowLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
