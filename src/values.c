...
// Set 1 (High Light)
unsigned const uint8_t ditherHighLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
// Set 2 (Low Light)
unsigned const uint8_t ditherLowLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
unsigned const uint8_t ditherNoHighLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
...
unsigned const uint8_t ditherNoLowLightValues[NUM_CONTRASTS][NUM_CONTRAST_SIZE] = {
