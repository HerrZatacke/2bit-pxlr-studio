...
MenuItem assistedOptionsMenu =   {  0, 0, 0, 2, NUM_ASSISTED_OPTIONS, 63, "   Set", " Exposure  Setting", &assistedOptions[0], 0, };
MenuItem contrastsMenuAssisted = {  7, 1, 0, 3,        NUM_CONTRASTS,  8, "Cntrst", "   Dither Contrast",       &contrasts[0], 0, };
