...
unsigned const int exposureTimes[NUM_EXPOSURE_TIMES] = { 0x0030, 0x0080, 0x0300, 0x0800, 0x1100, 0x2C00, 0x5000, 0xF000, 0xFF00, };
...
unsigned const char gains[NUM_GAIN_LEVELS] = {
  A001_GAIN_140,
  A001_GAIN_155,
  A001_GAIN_170,
  A001_GAIN_185,
...
unsigned const char edgeOpModes[NUM_EDGE_OP_MODES] = {
...
unsigned const char edgeExclusives[NUM_EDGE_EXCLUSIVE] = {
...
// Set 1 (High Light)
unsigned const char ditherHighLight[NUM_DITHERS][48] = {
...
// Set 2 (Low Light)
unsigned const char ditherLowLight[NUM_DITHERS][48] = {
...
unsigned const char ditherHighLows[NUM_DITHER_HIGHLOWS] = {
    DITHER_SET_HIGH,
    DITHER_SET_LOW,
};

unsigned const char edgeModes[NUM_EDGE_MODES] = {
  A004_EDGE_RATIO_050,
  A004_EDGE_RATIO_075,
  A004_EDGE_RATIO_100,
  A004_EDGE_RATIO_125,
...
unsigned const char invertOutputs[NUM_INVERT_OUTPUTS] = {
    A004_INVERT_OUTPUT_OFF,
    A004_INVERT_OUTPUT_ON,
};

unsigned const char voltageRefs[NUM_VOLTAGE_REFS] = {
  A004_VOLTAGE_REF_00,
  A004_VOLTAGE_REF_05,
  A004_VOLTAGE_REF_10,
  A004_VOLTAGE_REF_15,
...
unsigned const char zeroPoints[NUM_ZERO_POINTS] = {
  A005_ZERO_DISABLED,
  A005_ZERO_POSITIVE,
  A005_ZERO_NEGATIVE,
};
...
unsigned const char voltageOuts[NUM_VOLTAGE_OUTS] = {
